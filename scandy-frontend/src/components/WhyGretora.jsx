import styles from './WhyGretora.module.css';
...
const features = [
  ...
  },
  {
    ...
    desc: 'Your first three video QR codes are completely free — no credit card, no trial period, no catch. Create your first Gretora in under 2 minutes.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    desc: "Cards, gift tags, photo frames, wedding invitations, memory books, keychains — your QR code is just an image. If you can print on it, you can Gretora it.",
  },
];

export default function WhyGretora() {
  return (
      ...
      <div className={styles.inner}>
        <div>
          ...
          <p className={styles.desc}>
            A card says you remembered. A Gretora says you showed up in person — without being there.
          </p>
        </div>
