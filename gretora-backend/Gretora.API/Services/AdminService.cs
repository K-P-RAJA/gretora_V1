    ...
    public class AdminService
    {
        ...
        public async Task<dynamic> GetDashboardStats()
        {
            ...
            try
            {
                ...
                var recentScansRaw = await dbConnection.QueryAsync<dynamic>(@"
                    SELECT 
                        sl.id AS Id,
                    ...
                    LIMIT 5
                ");
                recentScans = recentScansRaw.Select(s => new {
                    Id = s.id,
        ...
        public async Task<IEnumerable<dynamic>> GetAllReports(string? status)
        {
            ...
            foreach (var item in result)
            {
                ...
                // Remove the report-locked privacy guard so admins can view the video context at any stage
        ...
        public async Task<IEnumerable<dynamic>> GetAllUsers(string? search)
        {
            ...
            return result.Select(u => new {
                ...
                Name = u.name,
                Email = u.email,
                HasAcceptedPolicy = u.hasacceptedpolicy,
                IsAdmin = u.isadmin,
                IsBanned = u.isbanned,
                CreatedAt = u.createdat,
                GreetingsCount = u.greetingscount,
        ...
        public async Task<IEnumerable<dynamic>> GetSupportTickets()
        {
            ...
            ";
            var result = await dbConnection.QueryAsync<dynamic>(sql);
